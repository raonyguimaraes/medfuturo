"""
Starter fabfile for deploying the medfuturo project.
...
# CHANGEME
env.hosts = ['user@medfuturo.example.com']
env.code_dir = '/srv/www/medfuturo'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/medfuturo/wsgi.py" % env.code_dir)
